    ...
    <div class="col-lg-12">
        <div class="box">
                    ...
                    <div class="col-lg-4">
                        <form action="{{ route('transaksi.simpan') }}" class="form-penjualan" method="post">
                           ...
                           {{--  <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label for="diterima" class="col-lg-2 control-label">Payment</label>
                                <div class="col-lg-8">
            ...
            <div class="box-footer">
                <button type="submit" class="btn btn-primary btn-sm btn-flat pull-right btn-simpan"><i class="fa fa-floppy-o"></i> Save</button>
            </div>
        </div>
    </div>
</div>
